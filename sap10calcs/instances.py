...
#%% SAP_Schema_19_2_0_parser
# - defines the module-level variable `SAP_Schema_19_1_0_parser`
# - This is an instance of lxml.etree.XMLParser

from . import classes_SAP_Schema_19_2_0

SAP_Schema_19_2_0_parser = etree.XMLParser(remove_blank_text=True)
...
SAP_Schema_19_2_0_parser.set_element_class_lookup(MyLookup_factory()())
...
###
from . import classes_RdSAP_Schema_21_0_1

RdSAP_Schema_21_0_1_parser = etree.XMLParser(remove_blank_text=True)
...
RdSAP_Schema_21_0_1_parser.set_element_class_lookup(MyLookup_factory()())
